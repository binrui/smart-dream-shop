package com.smart.shop.base.mail;
...
public class EmailSendTool {
	...
	private boolean mailHtml=false;


	public EmailSendTool() {
	}

	public EmailSendTool(String host,boolean mailHtml, String username, String password,
	...
	public static void main(String[] args) {
		EmailSendTool sendEmail = new EmailSendTool("smtp.163.com",false,
				"hello@163.com", "hello", "james@qq.com",
				"测试", "文本内容", "我", "", "");
		try {
			sendEmail.send();
		} catch (Exception ex) {
